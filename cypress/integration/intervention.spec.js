...
describe('Textfield tests', () => {
  ...
  it('user can edit the document', () => {
    ...
    cy.get('[data-cy=editor-participants]', { timeout: 100 }).click()
    cy.get('[data-cy=editor-participants]', { timeout: 100 }).type('Koira istuu puussa ja kana linnassa')
    cy.get('[data-cy=editor-matters]', { timeout: 100 }).click()
    cy.get('[data-cy=editor-matters]', { timeout: 100 }).type('Koira istuu puussa '.repeat(10))
    cy.get('[data-cy=editor-schedule]', { timeout: 100 }).click()
    cy.get('[data-cy=editor-schedule]', { timeout: 100 }).type('Koira istuu puussa ja kana linnassa')
