  ...
  metadata: [
    {
      ...
      "Määritelmä_en": "All applications in the main application procedure / Study places in the main application procedure",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Vetovoimaisuus",
      "Arviointialue_se": "Attraktionskraft",
      "Määritelmä_en": "Number of applicants accepting the UH study place/ number of study places of the main application procedure",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Opintojen sujuvuus ja valmistuminen",
      "Arviointialue_se": "Smidiga studier och utexaminering",
      "Määritelmä_en": "Percentage of graduates within target time of all graduates, as defined in the Ministry of Education and Culture´s funding model",
      "Määritelmä_fi": "Tavoiteajassa valmistuneiden osuus kaikista valmistuneista, OKM:n rahoitusmallin määritelmän mukaan",
      "Määritelmä_se": "Andelen utexaminerade inom måltiden av alla utexaminerade, enligt undervisnings- och kulturministeriets definition av finansieringsmodellen",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Opintojen sujuvuus ja valmistuminen",
      "Arviointialue_se": "Smidiga studier och utexaminering",
      "Määritelmä_en": "Percentage of students who completed more than 50 credits in the first academic year, including only those studies linked to this study right",
      "Määritelmä_fi": "Ensimmäisenä lukuvuonna yli 50 opintopistettä suorittaneiden opiskelijoiden osuus, mukana vain tähän opinto-oikeuteen kytketyt opinnot",
      "Määritelmä_se": "Andel studenter som läst mer än 50 högskolepoäng under det första läsåret, inklusive endast de studier som är kopplade till denna studierätt",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Opintojen sujuvuus ja valmistuminen",
      "Arviointialue_se": "Smidiga studier och utexaminering",
      "Määritelmä_en": "Share of students who have registered for more than three academic years. Date of review 20.9. Students who began their studies before 1 August 2017 will not be taken into consideration.",
      "Määritelmä_fi": "Läsnäolevaksi ilmoittautuneista opiskelijoista yli kolme lukuvuotta opiskelleiden osuus. Tarkastelupäivämäärä 20.9. Siirtyneet eivät mukana.",
      "Määritelmä_se": "Andel studenter som har varit registrerade i mer än tre läsår. Datum för granskning 20.9. Studenter som påbörjat sina studier före den 1 augusti 2017 kommer inte att beaktas.",
    ...
    },
    {
      ...
      "Määritelmä_en": "Well-being indicator: percentage of answers 4 or 5 to the feedback question \"I feel comfortable at my university.\" in the Finnish Bachelor’s Graduate Survey (Kandipalaute)",
      "Määritelmä_fi": "Hyvinvointi-indikaattori: Osuus kandipalautteen ”Voin hyvin yliopistossani” vastauksista 4-5",
      "Määritelmä_se": "Indikator för välbefinnande: Andel som svarat 4 eller 5 på feedbackfrågan ”Jag mår bra på mitt universitet” i Kandidatrespons (Kandipalaute)",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Palaute ja työllistyminen",
      "Arviointialue_se": "Feedback och sysselsättning",
      "Määritelmä_en": "Guidance indicator: percentage of answers 4 or 5 to the feedback question \"There has been sufficient guidance available for the organisation of my studies.\" in the Finnish Bachelor’s Graduate Survey (Kandipalaute)",
      "Määritelmä_fi": "Ohjausindikaattori: Osuus kandipalautteen ”Tarjolla on ollut riittävästi ohjausta opintojen suunnitteluun” vastauksista 4-5",
      "Määritelmä_se": "Indikator för handledning: Andel som svarat 4 eller 5 på feedbackfrågan ”Det har erbjudits tillräckligt med handledning för planeringen av studierna” i Kandidatrespons (Kandipalaute)",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Palaute ja työllistyminen",
      "Arviointialue_se": "Feedback och sysselsättning",
      "Määritelmä_en": "Percentage of answers 4 or 5 to the feedback question \"The teaching has been, to a large extent, of good quality.\" in the Finnish Bachelor’s Graduate Survey (Kandipalaute)",
      "Määritelmä_fi": "Osuus kandipalautteen ”Opetus on ollut mielestäni pääosin laadukasta” vastauksista 4-5",
      "Määritelmä_se": "Andel som svarat 4 eller 5 på feedbackfrågan ”Undervisningen har i huvudsak varit av god kvalitet.” i Kandidatrespons (Kandipalaute)",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Vetovoimaisuus",
      "Arviointialue_se": "Attraktionskraft",
      "Määritelmä_en": "Eligible applicants (Candidates with a foreign language) or all applicants (National language studies)",
      "Määritelmä_fi": "Hakukelpoiset hakijat (kv) tai kaikki hakijat (kotimaiskieliset koulutukset)",
      "Määritelmä_se": "Andelen behöriga sökande (internationella magisterprogram) eller alla sökande (finsk- och svenskspråkiga magisterprogram)",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Opintojen sujuvuus ja valmistuminen",
      "Arviointialue_se": "Smidiga studier och utexaminering",
      "Määritelmä_en": "Percentage of all graduates graduating more than one year after the target time, as defined in the Ministry of Education and Culture´s funding model.",
      "Määritelmä_fi": "Yli vuosi tavoiteajassa valmistuneiden osuus kaikista valmistuneista, OKM:n rahoitusmallin määritelmän mukaan",
      "Määritelmä_se": "Andel av alla utexaminerade som avlagt examen mer än ett år efter måltiden, enligt utbildnings- och kulturministeriets finansieringsmodell.",
    ...
    },
    {
      ...
      "Arviointialue_fi": "Opintojen sujuvuus ja valmistuminen",
      "Arviointialue_se": "Smidiga studier och utexaminering",
      "Määritelmä_en": "Share of students who have registered for more than five academic years (bachelor and master's study right) or two academic years (only  master's study right). Date of review 20.9. Students who began their studies before 1 August 2017 will not be taken into consideration.",
      "Määritelmä_fi": "Läsnäolevaksi ilmoittautuneista yli viisi (kandi+maisteri) tai kaksi (maisteri) lukuvuotta opiskelleiden osuus. Tarkastelupäivämäärä 20.9. Siirtyneet eivät mukana.",
      "Määritelmä_se": "Andel studenter som har registrerat sig för mer än fem läsår (kandidat- och magisterstudierätt) eller två läsår (endast magisterstudierätt). Datum för granskning 20.9. Studenter som påbörjat sina studier före den 1 augusti 2017 kommer inte att beaktas.",
      "Avainluvun nimi_en": "Accumalation of students",
      "Avainluvun nimi_fi": "Läsnäolevien kasautuminen",
      "Avainluvun nimi_se": "Ackumulering av antalet studenter"
    },
