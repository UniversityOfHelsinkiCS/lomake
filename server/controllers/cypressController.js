...
const initData = {
  metadata: [
    ...
    },
    {
      ...
      Määritelmä_fi: 'Tulossa 2026',
      Määritelmä_se: 'Kommer 2026',
      'Avainluvun nimi_en': 'Hakupaine',
      'Avainluvun nimi_fi': 'Hakupaine',
      'Avainluvun nimi_se': 'Kommer 2026',
    },
    {
      Liikennevalo: true,
      Kynnysarvot: '0;20;40;80',
      'Ohjelman taso': 'Tohtori',
      'Mittarin rajat': '0;100',
      Arviointialue_en: 'Attractiveness',
      Arviointialue_fi: 'Vetovoimaisuus',
      ...
      Määritelmä_fi: 'Tulossa 2026',
      Määritelmä_se: 'Kommer 2026',
      'Avainluvun nimi_en': 'Hakukelpoiset hakijat',
      'Avainluvun nimi_fi': 'Tulossa 2026',
      'Avainluvun nimi_se': 'Kommer 2026',
    },
    {
      Yksikkö: '%',
      Kynnysarvot: '0;10;20;30',
      Liikennevalo: true,
      'Ohjelman taso': 'Tohtori',
      'Mittarin rajat': '0;100',
      Arviointialue_en: 'Attractiveness',
      Arviointialue_fi: 'Vetovoimaisuus',
      Arviointialue_se: 'Attraktionskraft',
      Määritelmä_en: 'Työttömien osuus vuosi valmistumisen jälkeen.',
      Määritelmä_fi: 'Unmployment one year after graduation',
      Määritelmä_se: 'Unmployment one year after graduation',
      'Avainluvun nimi_en': 'Kansainväliset hakijat',
      'Avainluvun nimi_fi': 'Kansainväliset hakijat',
      'Avainluvun nimi_se': 'Kommer 2026',
    },
    {
      Kynnysarvot: '0;20;30;40',
      ...
      Määritelmä_fi: 'Tulossa 2026',
      Määritelmä_se: 'Kommer 2026',
      'Avainluvun nimi_en': 'Uudet väitöskirjatutkijat',
      'Avainluvun nimi_fi': 'Uudet väitöskirjatutkijat',
      'Avainluvun nimi_se': 'Kommer 2026',
    },
    {
      Kynnysarvot: '0;20;35;50',
    ...
    },
    {
      ...
      Arviointialue_fi: 'Opintojen sujuvuus ja valmistuminen',
      Arviointialue_se: 'Smidiga studier och utexaminering',
      Määritelmä_en: 'Less than 5 year.',
      Määritelmä_fi: 'Alle 5 vuotta',
      Määritelmä_se: 'Under 5 året',
      'Avainluvun nimi_en': 'Graduation within target time',
      'Avainluvun nimi_fi': 'Tavoiteajassa valmistuminen',
      'Avainluvun nimi_se': 'Utexaminering inom mållsat tid',
    },
    {
      Yksikkö: '%',
      Kynnysarvot: '0;30;50;70',
      ...
      Määritelmä_se:
        'Andelen utexaminerade inom måltiden av alla utexaminerade, enligt undervisnings- och kulturministeriets definition av finansieringsmodellen',
      'Avainluvun nimi_en': 'Graduation within target time',
      'Avainluvun nimi_fi': 'Väitöskirjatyön eteneminen',
      'Avainluvun nimi_se': 'Utexaminering inom målsatt tid',
    },
    {
      Yksikkö: '%',
    ...
    },
    {
      ...
      'Ohjelman taso': 'Tohtori',
      'Mittarin rajat': '0;5',
      Arviointialue_en: 'Employment',
      Arviointialue_fi: 'Työllistyminen',
      Arviointialue_se: 'Sysselsättning',
      Määritelmä_en: 'Employment one year after graduation, percentage',
      Määritelmä_fi: 'Työllistyminen vuosi valmistumisen jälkeen, osuus',
      Määritelmä_se: 'Sysselsättning ett år efter utexaminering',
      'Avainluvun nimi_en': 'Employment',
    ...
    },
    {
      ...
      Määritelmä_se: 'Sysselsättning ett år efter utexaminering',
      'Avainluvun nimi_en': 'Employment',
      'Avainluvun nimi_fi': 'Väitöskirjatutkijoiden hyvinvointi',
      'Avainluvun nimi_se': 'Sysselsättning',
    },
    {
      Kynnysarvot: '0;2;3;4',
      ...
      Määritelmä_se: 'Sysselsättning ett år efter utexaminering',
      'Avainluvun nimi_en': 'Employment',
      'Avainluvun nimi_fi': 'Väitöskirjatyön ohjaus',
      'Avainluvun nimi_se': 'Sysselsättning',
    },
    {
      Yksikkö: '%',
      Kynnysarvot: '100;20;10;5',
      Liikennevalo: true,
      'Ohjelman taso': 'Tohtori',
      'Mittarin rajat': '0;40',
      Arviointialue_en: 'Employment',
  ...
  Tohtoriohjelmat: [
    {
      // Perustiedot
      'Koulutusohjelman koodi': 'DP001',
      'Koulutusohjelman nimi': 'Doctoral Programme in Biomedicine',

      // Tohtoriohjelman avainluvut
      'Hakukelpoiset hakijat': 77,
      Hakupaine: 3,
      'Kansainväliset hakijat': 0.2,
      'Uudet väitöskirjatutkijat': 42,
      Tutkinnot: 33,
      'Tavoiteajassa valmistuminen': 0.22,
      'Läsnäolevien kasautuminen': 0.22,
      'Väitöskirjatutkijoiden hyvinvointi': 5,
      'Väitöskirjatyön eteneminen': 0.22,
      'Väitöskirjatyön ohjaus': 4,
      'Opetuksen laatu': 4,
      Työllistyminen: 0,
    ...
    },
    {
      ...
      'Hakukelpoiset hakijat': 77,
      Hakupaine: 3,
      'Kansainväliset hakijat': 0.42,
      'Uudet väitöskirjatutkijat': 42,
      Tutkinnot: 43,
      'Tavoiteajassa valmistuminen': 0.42,
      'Läsnäolevien kasautuminen': 0.42,
      'Väitöskirjatutkijoiden hyvinvointi': 3,
      'Väitöskirjatyön eteneminen': 0.42,
      'Väitöskirjatyön ohjaus': 3,
      'Opetuksen laatu': 3,
      Työllistyminen: 3,
...
const initKeyData = async (_req, res) => {
  try {
    try {
      ...
      TohtoriohjelmatValuesSchema.array().parse(initData.Tohtoriohjelmat)
    ...
    const rawData = {
      ...
      tohtoriohjelmat: initData.Tohtoriohjelmat,
