...
router.post('/reports/:studyProgrammeId/comments/', reports.createComment)
router.get('/reports/:studyProgrammeId/comments/', reports.getComments)
router.put('/reports/:studyProgrammeId/comments/', reports.updateComment)
router.delete('/reports/:studyProgrammeId/comments/', reports.deleteComment)
