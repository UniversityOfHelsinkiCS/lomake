...
export default {
  ...
  landingPage: {
    ...
    yearly: 'Opens on 1.5.2026',
    toArchive: 'Go to archive',
    toYearly: 'Go to annual follow-up',
    yearlyCardTitle: 'Annual follow-up 2026',
    yearlyCardContent: `All Bachelor's and Master's programmes use the revised annual follow-up in spring 2026. The form will open on 1.5.2026. `,
