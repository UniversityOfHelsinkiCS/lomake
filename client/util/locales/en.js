...
export default {
  common: {
    ...
    bm: "Bachelor's programmes & master's programmes",
    t: 'Doctoral programmes',
  ...
  landingPage: {
    ...
    yearlyCardTitle: 'Annual follow-up starting in 2025',
    yearlyCardContent: `The spring 2026 annual follow-up opens on 1.5.2026`,
  ...
  keyData: {
    ...
    editComment: 'Edit the opinion of the programme',
    saveComment: 'Save the opinion of the programme',
    ...
    Quality: 'Quality management document of the programme',
    noQuality: 'No response',
    ...
    qualitydocumentingHeader: 'Quality Management Documentation',
  ...
  document: {
    ...
    warningTextHeader: 'Intervention procedure for measures has been initiated for the degree programme.',
    warningTextDescription: `The Faculty's Dean of Teaching Resources and the Director of the Degree Programme together initiate the procedure for measures and invite key personnel of the degree programme to a negotiation. In the negotiation, the situation of the degree programme is mapped out, along with the potential need for further clarifications, and it is determined whether the degree programme can improve its situation with some available measures.`,
    ...
    generalDescription: `The date will be automatically updated according to the date the intervention procedure document is opened. In addition to the date, a name describing the event can be entered on the form (not compulsory). The names of the participants can be added to the box 'Participants'.`,
    ...
    option1: 'The key figures of the programme have improved sufficiently',
