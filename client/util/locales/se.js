export default {
  ...
  keyData: {
    ...
    editProgramme: 'Redigera programåtgärder',
    saveProgramme: 'Spara programåtgärder',
    Programme: 'Programåtgärder',
    noProgramme: 'Inget svar',
    editFaculty: 'Redigera fakultetsåtgärder',
