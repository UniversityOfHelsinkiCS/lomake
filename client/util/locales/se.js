...
export default {
  ...
  landingPage: {
    ...
    yearly: 'Öppnas 1.5.2026',
    toArchive: 'Gå till arkivet',
    toYearly: 'Gå till årlig uppföljning',
    yearlyCardTitle: 'Årlig uppföljning 2026',
    yearlyCardContent:
      'Alla kandidat- och magisterprogram kommer att använda den reviderade årliga uppföljningen under våren 2026. Blanketten öppnas den 1.5.2026.',
  ...
  keyData: {
    ...
    qualitydocumentingHeader: 'Dokumentation av kvalitetsstyrningsverktyg',
  ...
  qualitydocument: {
    header: 'Kvalitetsstyrningsdokument',
    curriculumProcessHeader: 'Läroplansprocessen',
    curriculumProcess: 'Läroplansprocessens effektivitet',
    guidancePoliciesHeader: 'Vägledningspraxis',
    guidancePolicies: 'Vägledningspraxisens effektivitet',
    feedbackHeader: 'Studentrespons',
    feedbackActions: 'Studentresponsens hantering och vidtagna åtgärder',
    feedbackDescription:
      'Hur har studentresponsen hanterats, vilka åtgärder har vidtagits på basis av responsen, och hur har dessa åtgärder kommunicerats?',
    feedbackUtilizationHeader: 'Utnyttjande av studentrespons',
    norppa: 'Utnyttjande av Norppa-kursrespons',
    careerMonitoring: 'Utnyttjande av karriäruppföljningsenkäten',
    bachelorFeedback: 'Utnyttjande av kandidatrespons',
    other: 'Utnyttjande av annan studentrespons',
    feedbackRegularityHeader: 'Regelbundenhet i hanteringen av studentrespons',
    annually: 'Hanteringen av studentrespons och åtgärder sker årligen',
    everySemester: 'Hanteringen av studentrespons och åtgärder sker varje termin',
