...
export default {
  ...
  landingPage: {
    ...
    yearlyCardTitle: 'Vuosiseuranta 2025 alkaen',
    yearlyCardContent: 'Kevään 2026 vuosiseuranta avautuu 1.5.2026.',
  ...
  keyData: {
    ...
    Quality: 'Koulutusohjelman laadunhallinnan dokumentti',
  ...
  document: {
    ...
    documentingDescription1: `Toimenpidemenettelyn neuvottelut ja niissä sovitut keskeiset asiat dokumentoidaan Tilannekuvalomakkeelle. Dokumentointi tapahtuu luomalla uusi dokumentti kustakin tapaamisesta ja kokouksesta, jotka toimenpidemenettelyyn liittyy. Toimenpidemenettelyn etenemisestä jää Tilannekuvalomakkeelle tiedot aikajärjestyksessä.`,
    documentingDescription2: `Toimenpidemenettely voidaan päättää varadekaanin ja koulutusohjelman johtajan yhteisellä päätöksellä, mikäli koulutusohjelman avainluvut ovat riittävästi parantuneet tai koulutusohjelmalle on käynnistynyt valmistelu, jossa koulutusohjelma liitetään toiseen koulutusohjelmaan tai lakkautetaan. Tilannekuvalomakkeella toimenpidemenettelyn voi lopettaa koulutusohjelmasta vastaavan tiedekunnan varadekaani. `,
  ...
  riskManagement: {
    ...
    description1:
      'Varadekaani arvioi vuosiseurannan perusteella tiedekunnan vastuulla olevien kandi- ja maisteriohjelmien tilannetta, käy läpi riskit ja arvioi mihin toimenpiteisiin tiedekunnassa on tarpeen ryhtyä.',
    description2:
      'Mikäli tiedekunnassa on koulutusohjelmia, joilla on vuosiseurannassa värimerkinnältään keltaisia tai punaisia arviointialueita, varadekaani muokkaa riskiarviot Suunta-järjestelmässä riskit-välilehdellä. Suunta-järjestelmään kirjataan tiedekunnan koulutuksen riskit, riskien käsittelytoimenpiteet, vastuuhenkilöt ja seuranta-aikataulu.',
