export default {
  ...
  keyData: {
    ...
    notUsed2025: 'Ei käytössä vuosina 2024 ja 2025',
  ...
  qualitydocument: {
    ...
    curriculumProcessHeader: 'Opetussuunnitelmaprosessi',
    ...
    feedbackUtilizationHeader: 'Opiskelijapalautteen hyödyntäminen',
    norppa: 'Norppa kurssipalautteiden hyödyntäminen',
    careerMonitoring: 'Uraseurantakyselyn hyödyntäminen',
    bachelorFeedback: 'Kandipalautteen hyödyntäminen',
    other: 'Muun opiskelijapalautteen hyödyntäminen',
    feedbackRegularityHeader: 'Opiskelijapalautteen käsittelyn säännöllisyys',
    annually: 'Opiskelijapalautteen käsittely ja toimenpiteet tapahtuvat vuosittain',
    everySemester: 'Opiskelijapalautteen käsittely ja toimenpiteet tapahtuvat lukukausittain',
