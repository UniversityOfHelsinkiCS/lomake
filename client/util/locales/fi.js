...
export default {
  ...
  landingPage: {
    ...
    yearly: 'Aukeaa 1.5.2026',
    toArchive: 'Siirry arkistoon',
    toYearly: 'Siirry vuosiseurantaan',
    yearlyCardTitle: 'Vuosiseuranta 2026',
    yearlyCardContent:
      'Koulutusohjelmien uudistettua vuosiseurantaa käytetään keväällä 2026 kaikissa kandi- ja maisteriohjelmissa. Lomake avautuu 1.5.2026',
