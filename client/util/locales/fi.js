export default {
  ...
  keyData: {
    ...
    Comment: 'Koulutusohjelman kommentti',
    noComment: 'Ei kommenttia',
    editProgramme: 'Muokkaa koulutusohjelman toimenpiteitä',
    saveProgramme: 'Tallenna koulutusohjelman toimenpiteet',
    Programme: 'Koulutusohjelman toimenpiteet',
    noProgramme: 'Ei vastausta',
    editFaculty: 'Muokkaa tiedekunnan toimenpiteitä',
