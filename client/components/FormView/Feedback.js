...
const Feedback = () => {
  return (
    <>
      ...
      <TextArea label="18. FEEDBACK: Please review the work done by the steering group to analyse the current status of the degree programme, and provide feedback for continued preparation."/>
    </>
  )
}
