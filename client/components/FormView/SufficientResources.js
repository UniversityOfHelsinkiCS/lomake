...
const SufficientResources = () => {
  return (
    <>
      ...
      <TextArea id="sufficient_resources_information_used" label="What other information and sources of information did you use?" />
      <TextArea id="sufficient_resources_information_needed" label="What information would you need?" />
