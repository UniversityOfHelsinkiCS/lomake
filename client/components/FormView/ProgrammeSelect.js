...
const ProgrammeSelect = () => {
  ...
  return (
    <>
      <Dropdown id="faculty" value={chosenFaculty} label="Faculty responsible for the programme *" options={faculties} onChange={handleChange} />
      <Dropdown id="degree_level" value={chosenDegreeLevel} label="Degree level *" options={degreeLevels} onChange={handleChange} />
      <Dropdown id="programme" value={chosenProgramme} label="Degree programme title *" options={filteredProgrammes} onChange={handleRoomChange} />
    </>
  )
}
