...
import { GroupKey } from '../../../lib/enums'
...
import { useGetAllDocumentsQuery } from '../../../redux/documents'
import { useGetReportsQuery } from '../../../redux/reports'
import { useFetchAllKeyDataQuery } from '../../../redux/keyData'
import { useGetInterventionProceduresQuery } from '../../../redux/interventionProcedures'
