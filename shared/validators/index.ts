...
export const QualityDocumentFormSchema = z
  .object({
    title: z.string().min(3, 'title'),
    curriculumChangesExample1: z.string().max(1500).optional(),
    curriculumCommunicationExample1: z.string().max(1500).optional(),
    curriculumFeedbackSourceExample1: z.string().max(1500).optional(),
    curriculumNameExample1: z.string().optional(),
    curriculumChangesExample2: z.string().max(1500).optional(),
    curriculumCommunicationExample2: z.string().max(1500).optional(),
    curriculumFeedbackSourceExample2: z.string().max(1500).optional(),
    curriculumNameExample2: z.string().optional(),
    curriculumChangesExample3: z.string().max(1500).optional(),
    curriculumCommunicationExample3: z.string().max(1500).optional(),
    curriculumFeedbackSourceExample3: z.string().max(1500).optional(),
    curriculumNameExample3: z.string().optional(),
    guidanceChangesExample1: z.string().max(1500).optional(),
    guidanceCommunicationExample1: z.string().max(1500).optional(),
    guidanceFeedbackSourceExample1: z.string().max(1500).optional(),
    guidanceNameExample1: z.string().optional(),
    guidanceChangesExample2: z.string().max(1500).optional(),
    guidanceCommunicationExample2: z.string().max(1500).optional(),
    guidanceFeedbackSourceExample2: z.string().max(1500).optional(),
    guidanceNameExample2: z.string().optional(),
    guidanceChangesExample3: z.string().max(1500).optional(),
    guidanceCommunicationExample3: z.string().max(1500).optional(),
    guidanceFeedbackSourceExample3: z.string().max(1500).optional(),
    guidanceNameExample3: z.string().optional(),
    learning: z.string().optional(),
    learningChangesExample1: z.string().max(1500).optional(),
    learningCommunicationExample1: z.string().max(1500).optional(),
    learningFeedbackSourceExample1: z.string().max(1500).optional(),
    learningNameExample1: z.string().optional(),
    learningChangesExample2: z.string().max(1500).optional(),
    learningCommunicationExample2: z.string().max(1500).optional(),
    learningFeedbackSourceExample2: z.string().max(1500).optional(),
    learningNameExample2: z.string().optional(),
    learningChangesExample3: z.string().max(1500).optional(),
    learningCommunicationExample3: z.string().max(1500).optional(),
    learningFeedbackSourceExample3: z.string().max(1500).optional(),
    learningNameExample3: z.string().optional(),
    learningRegularity: z.enum([
      'lessFrequently',
      'perCurriculumCycle',
      'annually',
      'everySemester',
    ...
    feedbackExamples: z.string().max(1500).optional(),
  })
  .strict()
